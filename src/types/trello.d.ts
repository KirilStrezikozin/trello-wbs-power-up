 ...
 *   - https://github.com/tatablack/leaner-coffee-powerup (Apache-2.0 license)
 *   - https://github.com/optro-cloud/trello-powerup-full-sample (MIT license)
 *
 * Modifications from Kiril Strezikozin are licensed under
 * the MIT license and include:
 *   - Altered capability handler types to reflect the Trello API.
 *
 * You may not use this file except in compliance with the Apache-2.0 license
 * governing original content and the MIT license governing modifications.
 *
...
export namespace Trello {
  ...
  namespace PowerUp {
    ...
    type CapabilityHandlers = {
      ...
      'board-buttons'?: (t: PowerUp.IFrame) => (BoardButtonUrl | PromiseLike<BoardButtonCallback> | BoardButtonCallback)[];
